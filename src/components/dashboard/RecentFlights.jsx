...
import { Plane, Calendar, User, ArrowRight, Plus, TrendingUp, Users } from "lucide-react";
...
export default function RecentFlights({ flights }) {
    ...
    <Card className="bg-white shadow-lg border-0">
      ...
      <CardContent>
        <div className="space-y-4">
          {flights.map((flight) => (
            <div key={flight.id} className="border-b border-slate-100 pb-4 last:border-b-0">
